        ...
        <div class="container mx-auto">
            <div class="flex flex-col md:flex-row w-8/12 md:w-full   bg-white rounded-xl mx-auto shadow-lg overflow-hidden">
                <div class="w-full md:w-1/2 flex flex-col items-center justify-center p-12 bg-no-repeat bg-cover bg-center" style="background-image: url('Image/Register-Background.png')">
                    ...
                    <p class="text-white">Bine ati venit pe site-ul nostru</p>
                </div>
                <div class="w-full md:w-1/2 py-16 px-12">
                    <h2 class="text-3xl mb-4">Autentificare</h2>
                    <p>Autentificati-va in contul dvs </p>
                    ...
                    <form @submit.prevent="loginUser">
                        ...
                        <div class="m-3 flex items-center">
                            <input type="checkbox" v-model="form.remember" class="ml-4 w-6 h-6"/>
                            <label class="ml-4">Tine-ma minte</label>
                        </div>
                        <div class="mt-4 p-4 flex justify-center">
                            <button type="submit" class="bg-green-500 py-1 px-5 rounded-lg font-medium text-2xl text-gray-700">Autentificare</button>
                        </div>
                    </form>
                    <div class="w-full md:w-full py-8 px-6">
                        Ai uitat parola? Poti sa o recuperezi prin <Link :href="route('password.request')" class="text-indigo-600">click aici </Link>
                    </div>
                </div>
            </div>
        </div>
